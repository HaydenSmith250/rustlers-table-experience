      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center">
          <FadeUp>
            ...
            <p className="font-body text-primary-foreground/70 text-lg leading-relaxed mb-6">
              ...
              and soak in the beauty of ranch country before or after your dining experience.
            </p>
